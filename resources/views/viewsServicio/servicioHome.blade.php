...
<header class="bg-gray-800 dark:bg-gray-900 py-5">
    ...
    <div class="flex flex-col gap-8  text-left">
        ...
        <h3 class="block font-sans text-3xl font-semibold leading-snug tracking-normal text-inherit antialiased text-center text-white">Comprar Servicios</h3>
...
<ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 ">
    ...
    <li class="me-2">
        <a href="{{route('servicios.mios')}}" class="inline-block p-4 rounded-t-lg hover:text-gray-600 hover:bg-gray-50  ">Mis servicios</a>
    </li>
                        ...
                        <div class="w-full max-w-sm bg-white rounded-lg shadow border-2 border-black mb-4 ">
                            ...
                            <div class="px-5 pb-5 text-center">
                                ...
                                <div class="mt-6">
                                    ...
                                    <a type="button"  href="{{ route('venta.detalles', ['id' => $servicio->id]) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Ver Detalles</a>
