...
<header class="bg-gray-800 dark:bg-gray-900 py-5">
    ...
    <div class="flex flex-col gap-8  text-left">
        ...
        <h3 class="block font-sans text-3xl font-semibold leading-snug tracking-normal text-inherit antialiased text-center text-white">Estado Cuentas</h3>
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-sm text-gray-500">Total Jades</div>
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                    ...
                    <div class="flex flex-col flex-grow ml-4">
                        <div class="text-sm text-gray-500">Voluntariados</div>
    ...
    <div class="w-full  mb-12 xl:mb-0 px-4 mx-auto mt-10">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
            ...
            <div class="inline-flex rounded-md shadow-sm" role="group">
                <a   href="{{route('cuenta.recarga')}}" type="button" class=" border-green-700 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border rounded-s-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
                ...
                <a href="{{route('cuenta.retiro')}}" type="button" class="  border-red-700 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border  rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
                    <svg class="w-6 h-6 text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="rounded-t mb-0 px-4 py-3 border-0">
                <div class="flex flex-wrap items-center">
                    <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                        <h3 class="font-semibold text-base text-blueGray-700">Estado Desglosado</h3>
                    </div>
